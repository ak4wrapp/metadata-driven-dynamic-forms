            ...
            >
              <Stack spacing={1}>
                ...
                <TextField
                  ...
                  value={c.renderer || ""}
                  onChange={(e) =>
                    updateArrayItem("columns", i, { renderer: e.target.value })
                  }
                ...
                <TextField
                  ...
                  onChange={(e) => {
                    try {
                      ...
                      updateArrayItem("columns", i, { rendererParams: parsed });
                    } catch {}
                  }}
            ...
            >
              <Stack spacing={1}>
                ...
                <TextField
                  ...
                  value={f.dependsOn || ""}
                  onChange={(e) =>
                    updateArrayItem("fields", i, { dependsOn: e.target.value })
                  }
              ...
              <Stack spacing={1}>
                ...
                {a.type === "form" && (
                  <TextField
                    ...
                    onChange={(e) =>
                      updateArrayItem("actions", i, {
                        form: { ...(a as any).form, component: e.target.value },
                      })
                    }
                    size="small"
                ...
                {a.type === "custom" && (
                  <TextField
                    ...
                    onChange={(e) =>
                      updateArrayItem("actions", i, { handler: e.target.value })
                    }
                    size="small"
